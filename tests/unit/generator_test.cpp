...
namespace {
UriGenerator make(const std::string& pattern) { return UriGenerator{pattern, true, false}; }
} // namespace
TEST_CASE("UriGenerator") {
  SECTION("with 2 patterns") {
    SECTION("throws when") {
      SECTION("no closing bracket in explicit range") {
        REQUIRE_THROWS(make("/my/{10:20}/desired/{1209:3298/route"));
      }
      SECTION("no starting number in explicit range") {
        REQUIRE_THROWS(make("/my/{10:20}/desired/{:3298}/route"));
      }
      SECTION("no ending number in explicit range") {
        REQUIRE_THROWS(make("/my/{10:20}/desired/{1209:}/route"));
      }
  ...
  SECTION("with 1 explicit range") {
    ...
    SECTION("throws when") {
      SECTION("no closing bracket in explicit range") {
        REQUIRE_THROWS(make("/my/desired/{1209:3298/route"));
      }
      SECTION("no starting number in explicit range") {
        REQUIRE_THROWS(make("/my/desired/{:3298}/route"));
      }
      SECTION("no ending number in explicit range") {
        REQUIRE_THROWS(make("/my/desired/{1209:}/route"));
      }
      SECTION("ending number less than starting number") {
    ...
    SECTION("from 0 to 1") {
      ...
      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 2); }
    }
    ...
    SECTION("from 14 to 16") {
      ...
      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 3); }
    }
    ...
    SECTION("from 1000000000 to 1000001000") {
      ...
      SECTION("generates correct number of entries.") {
        ...
        while (generator.next()) {
          ++number_of_entries_generated;
        }
        REQUIRE(number_of_entries_generated == 1001);
      }

      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 1001); }
    }
  }
  ...
  SECTION("with 1 implicit range") {
    ...
    SECTION("in octal") {
      ...
      SECTION("gives correct range size.") { REQUIRE(generator.get_range_size() == expected_size); }
  ...
  SECTION("with 2 explicit ranges") {
    ...
    SECTION("throws when") {
      SECTION("no closing bracket in explicit range") {
        REQUIRE_THROWS(make("/my/{0:1}/desired/{1209:3298/route"));
      }
      SECTION("no starting number in explicit range") {
        REQUIRE_THROWS(make("/my/{0:1}/desired/{:3298}/route"));
      }
      SECTION("no ending number in explicit range") {
        REQUIRE_THROWS(make("/my/{0:1}/desired/{1209:}/route"));
      }
      SECTION("ending number less than starting number") {
    ...
    SECTION("from 0 to 1") {
      ...
      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 4); }
    }
    ...
    SECTION("from 14 to 16") {
      ...
      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 6); }
    }
    ...
    SECTION("from 1000000000 to 1000001000") {
      ...
      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 2002); }
    }
  }
  ...
  SECTION("with 3 consecutive explicit ranges") {
    ...
    SECTION("throws when") {
      SECTION("no closing bracket in explicit range") {
        REQUIRE_THROWS(make("{0:1}{1209:3298{2:3}"));
      }
    ...
    SECTION("from 0 to 1") {
      ...
      SECTION("reports correct number of entries.") { REQUIRE(generator.get_range_size() == 8); }
    }
  ...
  SECTION("iterates telescoped suffix ranges from shortest to longest") {
    ...
    for (const char* const expected :
         {"/items/0", "/items/1", "/items/2", "/items/3", "/items/4", "/items/5", "/items/6",
          "/items/7", "/items/8", "/items/9", "/items/00", "/items/01"}) {
  ...
  SECTION("throws on exact cardinality overflow while preserving log cardinality") {
    ...
    REQUIRE(generator.get_log_range_size() >
            std::log(static_cast<double>(std::numeric_limits<size_t>::max())));
  }
